...
class evolveRISC(pluginTemplate):
    __model__ = "evolveRISC"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = config["simulator"]
        #self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","evolveRISC")
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        self.compile_cmd = 'riscv{1}-unknown-elf-gcc -march={0} \
            -static -mcmodel=medany -fvisibility=hidden -nostdlib -nostartfiles -Wa,-mno-arch-attr -mno-save-restore -mno-relax -g\
            -T '+self.pluginpath+'/env/link.ld\
            -I '+self.pluginpath+'/env/\
            -I ' + archtest_env + ' {2} -o {3} {4} -Wl,-Map={3}.map -Wa,-mno-arch-attr'
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for evolveRISC start building the '--isa' argument. the self.isa is dutnmae specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            # capture the directory where the artifacts of this test will be dumped/created. RISCOF
            # is going to look into this directory for the signature files
            test_dir = testentry['work_dir']

            # name of the elf file after compilation of the test
            elf = 'my.elf'

            # name of the signature file as per requirement of RISCOF. RISCOF expects the signature
            # to be named as DUT-<dut-name>.signature. The below variable creates an absolute path
            # of signature file.
            ...
            bin_cmd = f"riscv{self.xlen}-unknown-elf-objcopy -O binary {elf} {elf}.bin"
        ...
        # if you would like to exit the framework once the makefile generation is complete uncomment
        # the following line. Note this will prevent any signature checking or report generation.
        #raise SystemExit
