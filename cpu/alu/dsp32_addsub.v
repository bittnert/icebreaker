...
(
    ...
    SB_MAC16 #( .NEG_TRIGGER(0), 
                ...
                .TOPADDSUB_CARRYSELECT(3), //HCI (high carry in) is set to LCO ^ ADDSUBTOP to support add/subtract operation
        ...
        .CE(1'b1), 
	    .C(b[31:16]), 
        .A(a[31:16]),  //top adder/subtractor calculate A +(-) C.
        .B(a[15:0]),  //bottom adder/subtractor calculate B +(-) D.  
        .D(b[15:0]),  //Therefore, the lower 16 bits from a and b are used here.
	    .AHOLD(1'h0), 
        .BHOLD(1'h0), 
        .CHOLD(1'h0), 
        .DHOLD(1'h0),
