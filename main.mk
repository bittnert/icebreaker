...
%.a: $(V_SRC) #$(MEM_FILE)
	verilator -Wall --trace-fst --vpi --public-flat-rw --prefix $* --build "-DVL_DEBUG" -DTRACE_EXECUTION --top-module $(TOP) --cc $(V_SRC) --public
...
clean:
	rm -rf obj_dir *.vcd *.sim *.blif *.asc *.rpt *.bin *.json *.log $(ADD_CLEAN) *.sim
